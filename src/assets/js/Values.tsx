...
const itens: IItem[] = [
    ...
    { name: itensName.bonus.title, attrs: [statsCode.ARadd, statsCode.DEFadd, statsCode.ABSadd, statsCode.HPadd, statsCode.MPadd, statsCode.RESadd] },
    { name: itensName.bota.title, attrs: [statsCode.DEF, statsCode.DEFadd, statsCode.ABSadd] },
